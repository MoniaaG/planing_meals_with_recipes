    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <table class="table table-stripped table-bordered table-hover table-sm-responsive rounded">
                ...
                <tr>
                    <th class="col-12"><h4>{{ in_array(Route::currentRouteName(), ['recipe.shared']) ? 'Przepisy innych użytkowników' : 'Ulubione przepisy' }}</h4></th>
                </tr>
                </thead>
                <tbody>
                ...
                @endforeach
                 ...
                 @if(count($recipes) == 0)
                <tr>
                    <td colspan="3" class="text-center"><h3>Brak wyników</h3></td>
                </tr> 
                @endif
            </table>
        </div>
